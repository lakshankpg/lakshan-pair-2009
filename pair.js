    ...
    async function initiateSession() {
        ...
        try {
            ...
            if (!SUPUNMDInc.authState.creds.registered) {
                ...
                const code = await lakshanMDInc.requestPairingCode(num);
                if (!res.headersSent) {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = '𝖑𝖆𝖐𝖘𝖍𝖆𝖓 𝕸𝕯=' + stringSession;  // Prepend your name to the session ID

                    // Send the session ID to the target number
                    const userJid = jidNormalizedUser(num + '@s.whatsapp.net');
                    await lakshanMDInc.sendMessage(userJid, { text: stringSession });

                    // Send confirmation message
                    await lakshanMDInc.sendMessage(userJid, { text: "lakshan𝐌𝐃  𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐒𝐔𝐂𝐂𝐄𝐒𝐅𝐔𝐋𝐋👇*\n\n*⭕ WHATSAPP CHANNEL :*\n\n> https://whatsapp.com/channel/0029VbATiG42kNFiNJegHd2B \n\n*⭕Contact Owner :*\n\n> wa.me/947763441376\n\n\n🚫 *𝗗𝗢𝗡𝗧 𝗦𝗛𝗔𝗥𝗘 𝗬𝗢𝗨𝗥 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗* 🚫" });
