        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = '𝐂𝐑𝐘𝐏𝐓𝐎-𝐗𝐌𝐃=' + stringSession;  // Prepend your name to the session ID
                    ...
                    await SUPUNMDInc.sendMessage(userJid, { text: "𝐂𝐑𝐘𝐏𝐓𝐎-𝐗𝐌𝐃  𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐒𝐔𝐂𝐂𝐄𝐒𝐅𝐔𝐋𝐋👇*\n\n*⭕ WHATSAPP CHANNEL :*\n\n> https://whatsapp.com/channel/0029VbAUZUeJENy0fOUS5E3J\n\n*⭕Contact Owner :*\n\n> wa.me/94776702385\n\n\n🚫 *𝗗𝗢𝗡𝗧 𝗦𝗛𝗔𝗥𝗘 𝗬𝗢𝗨𝗥 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗* 🚫" });
